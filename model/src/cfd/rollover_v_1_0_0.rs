...
impl Cfd {
    pub fn accept_rollover_proposal_single_event(
        ...
        let to_event_id =
            olivia::next_announcement_after(now + self.settlement_time_interval_hours());
    ...
    pub fn handle_rollover_accepted_taker_single_event(
        ...
        let to_event_id = olivia::next_announcement_after(now + self.settlement_time_interval_hours());
